				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="/about"> A propos</a></p>
						</div>	
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 about-video-left">
							...
							<a class="primary-btn mt-30" href="#" style="border-radius: 20px;background:rgb(180, 0, 45);color:white">Get Started Now</a>
						</div>
						<div class="col-lg-6  justify-content-center align-items-center d-flex relative">
							
							<a><img class="img-fluid mx-auto" src="img/g4.jpg" alt=""></a>
						</div>
					</div>
				</div>	
			</section>
