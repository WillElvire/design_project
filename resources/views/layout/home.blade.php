@extends('welcome')
@section('title','Accueil |Kiyani design')
@section('container')
@include('layout/partials/header')
				...
				<div class="container">
					<div class="row fullscreen d-flex justify-content-center align-items-center">
						<div class="banner-content col-lg-9 col-md-12 justify-content-center ">
							...
							<a href="#" class="primary-btn header-btn text-uppercase mt-10" style="border-radius: 20px;background:rgb(0, 20, 65)">Designer mon interieure</a>
							<a href="#" class="primary-btn header-btn text-uppercase mt-10" style="border-radius: 20px;background:rgb(180, 0, 45)">Choisir mes articles</a>
						</div>											
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-md-12 pb-50 header-text text-center">
							<h1 class="mb-10">Quesque nous offrons à nos clients</h1>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-service">
								<a href="#"><h4> Design d'Interieure</h4></a>
								<p>
								...
								<a href="#" class="primary-btn header-btn text-uppercase mt-10" style="border-radius: 20px;background:rgb(180, 0, 45)">Voir nos services</a>
							</div>
						</div>	
						<div class="col-lg-4">
							<div class="single-service">
								<a href="#"><h4>Design propre à vous</h4></a>
								<p>
						...
						<div class="col-lg-4">
							<div class="single-service">
								<a href="#"><h4>Une maison de reve</h4></a>
								<p>
								...
								<div class="content">
								    <a href="#" target="_blank">
								      ...
								      <div class="content-details fadeIn-bottom">
								        ...
								        <a href="/services" class="primary-btn header-btn text-uppercase mt-10" style="border-radius: 20px;background:rgb(180, 0, 45)">Voir nos services</a>
								      </div>
								    </a>
								</div>
							</div>
			...
			<!-- Start feature Area -->
			<section class="feature-area section-gap" style="background:rgb(180, 0, 45)">
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="col-md-12 pb-40 header-text text-center">
							<h1 class="pb-10 text-white">Nos atouts</h1>
		            ...
		            <div class="row d-flex justify-content-center">
		                <div class="menu-content pb-70 col-lg-8">
		                    <div class="title text-center">
		                        <h1 class="mb-10">Nos clients disent</h1>
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-9">
							<div class="title text-center">
								<h1 class="mb-10">Exemples de design que nous proposons</h1>
